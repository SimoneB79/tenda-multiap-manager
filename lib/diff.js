...
/**
 * Compare two snapshot objects and return a structured diff.
 * Returns an array of { key, label, category, left, right, status }
 * status: 'same' | 'diff' | 'left_only' | 'right_only'
 */
...
/**
 * Flatten a single module's data into field-level entries.
 */
